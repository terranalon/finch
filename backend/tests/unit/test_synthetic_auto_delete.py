...
Tests the delete_synthetic_sources helper function that finds and removes
...
class TestDeleteSyntheticSources:
    """Tests for delete_synthetic_sources helper function."""
    ...
    def test_no_synthetic_sources_returns_empty_stats(self):
        ...
        result = delete_synthetic_sources(mock_db, account_id=1, broker_type="ibkr")
    ...
    def test_finds_synthetic_sources_by_account_and_broker(self):
        ...
        delete_synthetic_sources(mock_db, account_id=42, broker_type="ibkr")
    ...
    def test_deletes_source_records(self):
        ...
        delete_synthetic_sources(mock_db, account_id=1, broker_type="ibkr")
...
class TestUploadEndpointSyntheticCleanup:
    """Test that the upload endpoint calls delete_synthetic_sources."""
    ...
    def test_upload_calls_delete_synthetic_before_import(
        ...
        """Upload endpoint should call delete_synthetic_sources before parsing."""
        # This test verifies the function exists and is importable,
        # and that it's wired into the upload endpoint.
        from app.services.brokers.ibkr.synthetic_import_service import delete_synthetic_sources

        # Verify the function is callable
        assert callable(delete_synthetic_sources)
