...
def _make_ticker_market_data(symbol: str, price: float) -> TickerMarketData:
    ...
    return TickerMarketData(
        symbol=symbol, price=d, open=d, high=d, low=d, close=d,
        volume=1000000, market_cap=Decimal("1000000000"),
        pe_ratio=Decimal("25"), forward_pe=Decimal("22"),
        eps=Decimal("6"), dividend_rate=Decimal("1"),
        dividend_yield=Decimal("0.005"), payout_ratio=Decimal("0.15"),
        description="Test", exchange="NMS", website="https://test.com",
        ceo="Test CEO", employees=10000, beta=Decimal("1.2"),
        avg_volume=5000000, earnings_date=None, ex_dividend_date=None,
        target_est=Decimal("200"), week_52_high=Decimal("190"),
        week_52_low=Decimal("140"), peg_ratio=Decimal("1.5"),
        expense_ratio=None, fund_family=None, nav=None,
    )
...
def _make_crypto_market_data(symbol: str, price: float) -> CryptoMarketData:
    ...
    return CryptoMarketData(
        symbol=symbol, price=d, high_24h=d, low_24h=d,
        volume=Decimal("1000000000"), market_cap=Decimal("500000000000"),
        market_cap_rank=1, circulating_supply=Decimal("19000000"),
        max_supply=Decimal("21000000"), ath=d, ath_date=None,
        atl=Decimal("1"), atl_date=None,
    )
